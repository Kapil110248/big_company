...
export const dealsService = {
    ...
    createDeal: async (data: any) => {
        const response = await axios.post(`${API_URL}/admin/deals`, data, getAuthHeader());
        return response.data;
    },
    updateDeal: async (id: string, data: any) => {
        const response = await axios.put(`${API_URL}/admin/deals/${id}`, data, getAuthHeader());
        return response.data;
    },
    deleteDeal: async (id: string) => {
        const response = await axios.delete(`${API_URL}/admin/deals/${id}`, getAuthHeader());
        return response.data;
    }
};
